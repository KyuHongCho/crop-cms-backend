...
# app.db.db owns the connection settings (env vars, secret handling) and the
# single Base; reusing ASYNC_DB_URL means alembic can never disagree with the
# application about how to reach the database. The bare import of
...
# Drives autogenerate: Base.metadata carries every table registered by the
# import above.
