...
data/ecocrop/<slug>.json rather than authored here. There is no delete either,
and the database backs that up -- Item.crop_id is ON DELETE RESTRICT, so a
crop that still has documents about it cannot be removed.
